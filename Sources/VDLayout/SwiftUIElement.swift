...
//import SwiftUI
//
//public struct SwiftUIElement<Content: View>: UIStructure {
...
//	
//	@inlinable
//	public static func buildExpression<T: View>(_ expression: T, file: String = #filePath, line: UInt = #line, column: UInt = #column) -> UI {
...
//	public let layout: () -> UI
//	@StateObject private var storage = ViewModel()
//	
//	public init(_ layout: @escaping () -> UI) {
//		self.layout = layout
//	}
//	
